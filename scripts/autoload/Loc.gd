...
var _strings := {
	"pt_BR": {
		...
		"post_save": "GUARDIÃO DA OUTLANE!",
		"skill_shot": "SKILL SHOT",
		"loop": "VOLTA DO CLAUSTRO",
		"extra_ball": "BOLA EXTRA!",
		"bonus_mult": "BÔNUS x%d",
		"prayer": "ORAÇÃO RELÂMPAGO",
		"indulgence_ready": "INDULGÊNCIA NA SACRISTIA",
		"sacristy_letter": "SACRISTIA: %s",
		"end_bonus": "BÔNUS: %s sopros x %d relíquias x%d = %s",
		"captive": "SINO: BÔNUS x%d",
		"ramp": "RAMPA!",
		"orbit": "ÓRBITA",
